...
<@html ;section>
	...
	<#if section="body-content">
		...
		<div class="content">
			<ul>
				<li><a href="javascript:;">numberspinner</a></li>
			</ul>
		</div>
		...
		<div class="title">datagrid</div>
		<div class="content">
			<ul>
				<li><a href="javascript:;">datagrid</a></li>
			</ul>
		</div>
		...
		<div class="title">selector-employee</div>
		<div class="content">
			<ul>
				<li><a href="javascript:;">selector-employee</a></li>
			</ul>
		</div>
	</#if>
